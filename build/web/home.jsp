        ...
        <section class="pt-5">
            ...
            <div class="container px-4 px-lg-5 mt-4">
                <div id="home-all-product" class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <c:forEach items="${requestScope.listProducts}" var="LPS">
                        <!-- Product -->
                        <div class="col mb-5 product-all">
                            <div class="card h-100">
                                ...
                                <div class="position-absolute bg-black text-white default-cursor"
                                    ...
                                    ${LPS.status == 1 ? "Có Sẵn" : "Hết Hàng"}
                                </div>
                                <!-- Product image-->
                                <c:url var="linkImg" value="ProductDetailController">
                                    <c:param name="pid" value="${LPS.id}"></c:param>
                                </c:url>
                                <a href="${linkImg}" class="img-h-350"><img src="${LPS.imgPath}" alt="Product IMG" /></a>
                                <!-- Product details-->
                                <div class="card-body p-2">
                                    <div class="text-center product-info">
                                        ...
                                        <div class="price text-center fs-4 fw-bold default-cursor text-black">
                                            <span class="text-muted text-decoration-line-through">${LPS.price+10000}đ</span>
                                            ${LPS.price}đ
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="w-100 text-end">
                    <div class="btn-group mb-5" role="group" aria-label="Basic example">
                        <button onclick="loadMore('loadMoreOurProduct', this)" class="btn btn-primary me-2">Xem thêm</button>
                        <a href="ViewAllController" type="button" class="btn btn-primary">Xem tất cả</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div style="background-color: #f3f3f3;">
                ...
                <div class="container px-4 px-lg-5 mt-3">
                    ...
                    <div id="home-best-seller" class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        <c:forEach items="${requestScope.listBestSellerProducts}" var="LBSP">
                            <!-- Product -->
                            <div class="col mb-5">
                                <div class="card h-100">
                                    <!-- Sale badge-->
                                    <div class="position-absolute bg-black text-white default-cursor"
                                         style="padding: 5px 15px; left: 15px; top: 15px;">
                                        ${LBSP.status == 1 ? "Có sẵn" : "Hết hàng"}
                                    </div>
                                    <!-- Product image-->
                                    <c:url var="linkImg" value="ProductDetailController">
                                        <c:param name="pid" value="${LBSP.id}"></c:param>
                                    </c:url>
                                    <a href="${linkImg}" class="img-h-350"><img src="${LBSP.imgPath}" alt="Product IMG" /></a>
                                    <!-- Product details-->
                                    <div class="card-body p-2">
                                        <div class="text-center product-info">
                                            <div class="category ms-3 mt-3 text-start">
                                            ...
                                            <div class="price text-center fs-4 fw-bold default-cursor">
                                                <span class="text-muted text-decoration-line-through">${LBSP.price+10000}đ</span>
                                                ${LBSP.price}đ
                                            </div>
                                        </div>
                                    </div>
