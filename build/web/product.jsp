...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .list-group {
                ...
                max-width: 300px; /* Giảm chiều rộng của danh sách */
    ...
    <body class="animsition">
        ...
        <div id="search-nav" class="d-flex align-items-center">
            <div class="container text-center">
                <span class="body">
                    ...
                    <span class="txt-m-bold txt-orange default-cursor text-warning">Sản Phẩm</span>
                </span>
            </div>
        </div>
        <!-- Product List -->
        <div class="container mb-5">
            <div class="row">
                <div class="col-md-3">
                    <h3 class="mb-4 default-cursor text-black">Danh Sách Sản Phẩm</h3>
                    <div class="list-group">
                        <a type="button" class="list-group-item list-group-item-action ${(empty requestScope.category)? "active" : ""}" href="ViewAllController">Tất Cả Sản Phẩm</a>
                                    ...
                                    <div class="col mb-5">
                                        <div class="card h-100">
                                            ...
                                            <div class="position-absolute bg-black text-white default-cursor"
                                                ...
                                                ${LP.status == 1 ? "Có sẵn" : "Hết hàng"}
                                            </div>
                                            <!-- Product image-->
                                            <c:url var="linkImg" value="ProductDetailController">
                                                <c:param name="pid" value="${LP.id}"></c:param>
                                            </c:url>
                                            <a href="${linkImg}" class="img-h-350"><img src="${LP.imgPath}" alt="Product IMG" /></a>
                                            <!-- Product details-->
                                            <div class="card-body p-2">
                                                <div class="text-center product-info">
                                                    ...
                                                    <div class="price text-center fs-4 fw-bold default-cursor text-black">
                                                        <span class="text-muted text-decoration-line-through">${LP.price+10000}đ</span>
                                                        ${LP.price}đ
                                                    </div>
                                                </div>
                                            </div>
