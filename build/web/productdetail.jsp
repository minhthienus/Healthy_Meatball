        ...
        <div id="search-nav" class="d-flex align-items-center">
            <div class="container text-center">
                <span class="body">
                    ...
                    <span class="txt-m-bold txt-orange default-cursor text-warning">Chi Tiết Sản Phẩm</span>
                </span>
            </div>
        </div>
        <!-- Toast MSG -->
        ...
        <section>
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center mb-4">
                    <div class="col-md-6 text-md-end"><img class="card-img-top mb-5 mb-md-0" src="${product.imgPath}" alt="..." style="width: 70%"/>
                    </div>
                    <div class="col-md-6">
                        <div class="small mb-1 default-cursor">ID: ${product.id}</div>
                        <div class="small mb-1 default-cursor">Loại: ${sessionScope.listCategories.get(product.categoryId)}</div>
                        <h1 class="display-5 fw-bolder default-cursor">${product.name}</h1>
                        <div class="fs-1 mb-3 default-cursor">
                            <span class="text-decoration-line-through text-black-50">${product.price+10000}đ</span>
                            <span class="text-danger">${product.price}đ</span>
                        </div>
                        <p class="lead default-cursor">Mô tả: ${product.description}</p>
                        <div class="d-flex">
                            <a onclick="addToCartAsync(${product.id})" class="btn btn-outline-dark flex-shrink-0">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Trang chủ</button>
                        <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Thông tin</button>
        ...
        <section class="pt-5 bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <c:forEach items="${requestScope.listRelativeProducts}" var="RL">
                        <!-- Product -->
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <div class="position-absolute bg-black text-white default-cursor"
                                    ...
                                    ${RL.status == 1 ? "Có sẵn" : "Hết hàng"}
                                </div>
                                <!-- Product image-->
                                <c:url var="linkImg" value="ProductDetailController">
                                    <c:param name="pid" value="${RL.id}"></c:param>
                                </c:url>
                                <a href="${linkImg}" class="img-h-350"><img src="${RL.imgPath}" alt="Product IMG" /></a>
                                <!-- Product details-->
                                <div class="card-body p-2">
                                    <div class="text-center product-info">
                                        ...
                                        <!-- Product name-->
                                        <div class="name">
                                            <c:url var="linkName" value="ProductDetailController">
                                                <c:param name="pid" value="${RL.id}"></c:param>
                                            </c:url>
                                        ...
                                        <div class="price text-center fs-4 fw-bold default-cursor">
                                            <span class="text-muted text-decoration-line-through">${RL.price+10000}đ</span>
                                            ${RL.price}đ
                                        </div>
                                    </div>
                                </div>
