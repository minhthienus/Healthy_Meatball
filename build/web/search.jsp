    ...
    <body class="animsition">
        ...
        <div id="search-nav" class="d-flex align-items-center">
            <div class="container text-center">
                <span class="body">
                    ...
                    <span class="txt-m-bold txt-orange default-cursor text-warning">Tìm Kiếm</span>
                </span>
            </div>
        </div>
        <!-- Toast MSG -->
        ...
        <c:if test="${not empty requestScope.NO_RESULT}">
            ...
            <div id="no-result" class="mb-5">
                <div class="container">
                    <span class="sub-title fs-3 text-black">Không thể tìm thấy bất kỳ kết quả nào cho các từ khóa trên.</span>
                    <div class="main-title">Nhập từ khóa để tìm kiếm</div>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <form class="py-md-2" action="SearchController">
                                ...
                                <button type="submit" value="search" class="btn btn-outline-danger">Tìm kiếm</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div id="result" class="pt-4">
                <div class="container">
                    <div class="main-title text-black">
                        Có <span>${requestScope.totalProducts}</span> kết quả tìm kiếm phù hợp
                    </div>
                    <div class="container px-4 px-lg-5 mt-4">
                        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                            <c:forEach items="${requestScope.listProducts}" var="L">
                                <!-- Product -->
                                <div class="col mb-5">
                                    <div class="card h-100">
                                        ...
                                        <div class="position-absolute bg-black text-white default-cursor"
                                            ...
                                            ${L.status == 1 ? "Có sẵn" : "Hết hàng"}
                                        </div>
                                        <!-- Product image-->
                                        <c:url var="linkImg" value="ProductDetailController">
                                            <c:param name="pid" value="${L.id}"></c:param>
                                        </c:url>
                                        <a href="${linkImg}" class="img-h-350"><img src="${L.imgPath}" alt="Product Img" /></a>
                                        <!-- Product details-->
                                        <div class="card-body p-2">
                                            <div class="text-center product-info">
                                                ...
                                                <div class="price text-center fs-4 fw-bold default-cursor text-black">
                                                    <span class="text-muted text-decoration-line-through">${L.price+10000}đ</span>
                                                    ${L.price}đ
                                                </div>
                                            </div>
                                        </div>
