                    ...
                    if (role == 0) {
                        ...
                        if (!cartStr.equals("")) {
                            ...
                            for (String i : s) {
                                ...
                                carts.put(pid, new Cart(product, quantity));
                            }
                ...
                if (email == null) {
                    ...
                    if (account != null) {
                        if (account.getStatus() == 0) {
                            request.setAttribute("ERROR_MASSEGE", "Tài khoản của bạn đã bị khóa! Vui lòng liên hệ với quản trị viên để mở khóa!");
                            url = LOGIN;
                        } else {
                            session.setAttribute("LOGIN_USER", account);
                            if (ADMIN == account.getRole()) {
                                ...
                                request.setAttribute("ERROR_MASSEGE", "Vai trò của bạn không được phép!");
                            }
                        ...
                        request.setAttribute("ERROR_MASSEGE", "Sai email hoặc mật khẩu!");
                    }
                }
            }
        } catch (Exception e) {
