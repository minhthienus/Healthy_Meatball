            ...
            <c:choose>
                <c:when test="${(sessionScope.carts == null) || (sessionScope.carts.size() == 0)}">
                    <div class="empty-cart text-center">
                        <img class="img-fluid" src="img/empty_cart.png" alt="Empty Cart Image">
                        <div class="header-cart-total mt-3">Giỏ hàng đang trống</div>
                    </div>
                </c:when>
                <c:otherwise>
                            ...
                            <c:forEach items="${sessionScope.carts}" var="C">
                                <li class="header-cart-item flex-w flex-t m-b-12">
                                    <div class="header-cart-item-img">
                                        <img src="${C.value.product.imgPath}" alt="IMG">
                                    </div>

                                    <div class="header-cart-item-txt p-t-8">
                                        <c:url var="detailLink" value="ProductDetailController">
