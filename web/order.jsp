        ...
        <div id="search-nav" class="d-flex align-items-center">
            <div class="container text-center">
                <span class="body">
                    ...
                    <span class="txt-m-bold txt-orange default-cursor text-warning">Đặt hàng</span>
                </span>
            </div>
        </div>
        <!-- Orders List -->
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <form action="SearchOrderController" class="mt-3 text-black">
                        <label class="fs-4">Tìm kiếm đơn hàng</label>
                ...
                <div class="col-md-9 default-cursor">
                    <h3 class="text-center mb-4 pt-4 pt-md-0 text-black">Danh Sách Đơn Hàng</h3>
                    <c:choose>
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="p-4 text-center fs-3" style="color: red;">
                                                                            Bạn có chắc chắn muốn hủy đơn hàng này không "<span class="text-dark">${O.orderId}</span>"?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="${cancelOrder}" type="button" class="btn btn-danger">Có</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="p-4 text-center fs-3">
                                                                            Bạn có chắc chắn muốn đặt lại đơn hàng này không "<span style="color: red;">${O.orderId}</span>"?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                                                                            ...
                                                                            <a href="${orderAgain}" type="button" class="btn btn-danger">Có</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
