                        ...
                        <table class="table-order-detail">
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.listOrdersDetail}" var="D">
                                    <tr>
                                        <c:forEach items="${requestScope.listProductOrder}" var="P">
                                            <c:if test="${D.productId eq P.id}">
                                                <td>
                                                    <img class="product-img" src="${P.imgPath}" alt="">
                                                    <div class="product-brand">
                                                        <div class="product-name">
                                                            <c:url var="productD" value="ProductDetailController">
                                                                <c:param name="pid" value="${P.id}"></c:param>
                                                            </c:url>
                                                            <a href="${productD}">${P.name}</a>
                                                        </div>
